package ru.bogdanov.SpringBootsecurityjwt.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${bogdanov.app.jwtSecret}")
    private String jwtSecret;

    @Value("${bogdanov.app.jwtExpirationMs}")
    private int jwtExpirationMs;

    @Value("${bogdanov.app.jwtCookieName}")
    private String jwtCookie;

    @Value("${bogdanov.app.jwtRefreshCookieName}")
